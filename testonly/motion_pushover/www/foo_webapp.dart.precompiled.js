...
Interceptor: {"": "Object;",
  ...
  "%": "ArrayBuffer|Blob|CanvasGradient|CanvasPattern|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList|TextMetrics"
},
...
ListIterator: {"": "Object;_iterable,_length,_dev$_index,_dev$_current",
  ...
  moveNext$0: function() {
    ...
    this._dev$_index = this._dev$_index + 1;
    return true;
  }
},
...
ListQueue: {"": "IterableBase;_table,_head,_tail,_modificationCount",
  ...
  addAll$1: function(_, elements) {
    var t1;
    for (t1 = new P._GeneratorIterator(elements._count, elements._generator, 0, null); t1.moveNext$0();)
      this._add$1(t1._current);
  },
  toString$0: function(_) {
    return H.IterableMixinWorkaround_toStringIterable(this, "{", "}");
  },
...
_GeneratorIterator: {"": "Object;_count,_generator,_index,_current",
  ...
  moveNext$0: function() {
    var t1 = this._index;
    if (t1 < this._count) {
      this._current = this._generator$1(t1);
...
outputMsg: function(msg) {
  ...
  t1 = $.count;
  $.count = t1 + 1;
  if (C.JSInt_methods.$mod(t1, 30) === 0)
    $.get$output().textContent = "";
  text = $.get$output().textContent.length !== 0 ? msg + "\n" + $.get$output().textContent : msg;
  $.get$output().textContent = text;
},
...
initWebSocket: function(retrySeconds) {
  ...
  G.outputMsg("Connecting to websocket ws://192.168.2.42:8888/ws");
  ...
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.initWebSocket_closure()), t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  t3 = $.ws;
  t3.toString;
  t3 = new W._EventStream(t3, C.EventStreamProvider_close._eventType, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t2 = new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(new G.initWebSocket_closure0(retrySeconds, t1)), t3._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = $.ws;
  t2.toString;
  t2 = new W._EventStream(t2, C.EventStreamProvider_error._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new G.initWebSocket_closure1(t1)), t2._useCapture);
  ...
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.initWebSocket_closure2()), t1._useCapture);
...
main: function() {
  ...
  G.initWebSocket(2);
  t1 = $.get$dataQueue();
  t2 = new P._GeneratorIterable($.get$lineUp().length, new G.main_closure());
  H.setRuntimeTypeInfo(t2, [null]);
  t1.addAll$1(t1, t2);
},
...
drawQueue: function() {
  var t1, dataPlot;
  t1 = J.get$children$x($.get$plotArea());
  t1.clear$0(t1);
  t1 = $.get$dataQueue();
  dataPlot = U.plot(t1.toList$1$growable(t1, false), "#3C3D36", "#90AB76", "Navy", "FireBrick", "#simPlotHere", 1, 2, 1, "linepts", null, null, null, null, $.get$lineUp(), null, null);
  dataPlot.grid$0();
  dataPlot.xlabel$2$color("XLabel", "#3C3D36");
  dataPlot.ylabel$1("YLabel");
},
...
initWebSocket_scheduleReconnect: {"": "Closure;box_0,retrySeconds_1",
  call$0: function() {
    var t1, t2;
    t1 = this.box_0;
...
initWebSocket_scheduleReconnect_closure: {"": "Closure;retrySeconds_2",
  call$0: function() {
...
initWebSocket_closure: {"": "Closure;",
  call$1: function(e) {
    G.outputMsg("Connected");
    $.ws.send("Hello from Dart!");
  },
  $is_args1: true
},

initWebSocket_closure0: {"": "Closure;retrySeconds_3,scheduleReconnect_4",
  call$1: function(e) {
    G.outputMsg("Websocket closed, retrying in " + this.retrySeconds_3 + " seconds");
    this.scheduleReconnect_4.call$0();
  },
  $is_args1: true
},

initWebSocket_closure1: {"": "Closure;scheduleReconnect_5",
  call$1: function(e) {
    G.outputMsg("Error connecting to ws");
...
initWebSocket_closure2: {"": "Closure;",
  call$1: function(e) {
    ...
    G.outputMsg("msg " + $.count + " : " + H.S(t1.get$data(e)));
    $.get$dataQueue()._add$1(H.Primitives_parseInt(t1.get$data(e), null, null));
    t1 = $.get$dataQueue();
    if (t1.get$length(t1) > $.get$lineUp().length)
      $.get$dataQueue().removeFirst$0();
    G.drawQueue();
  },
  $is_args1: true
},
...
["simplot", "package:simplot/simplot.dart", , U, {
plot: function(y1, color1, color2, color3, color4, container, index, linewidth, range, style1, style2, style3, style4, xdata, y2, y3, y4) {
  var t1, _pheight, graphContainer, _plotCanvas, t2, context, _ydata, _style, _color;
  t1 = {};
  t1.xdata_0 = xdata;
  if (y1.length === 0)
    throw H.wrapException(new P.ArgumentError("No data to be plotted."));
  _pheight = range === 1 ? 600 : 450;
  graphContainer = document.querySelector(container);
  _plotCanvas = W.CanvasElement_CanvasElement(null, null);
  t2 = J.getInterceptor$x(_plotCanvas);
  t2.set$attributes(_plotCanvas, H.fillLiteralMap(["id", "simPlot" + index, "class", "simPlot", "width", "600", "height", "" + _pheight], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null)));
  graphContainer.toString;
  new W._ChildNodeListLazy(graphContainer)._this.appendChild(_plotCanvas);
  context = t2.get$context2D(_plotCanvas);
  context.fillStyle = "white";
  context.fillRect(0, 0, 600, _pheight);
  context.fillStyle = "black";
  if (t1.xdata_0 == null) {
    t2 = y1.length;
    if (style1 === "data")
      t1.xdata_0 = P.List_List$generate(t2, new U.plot_closure(), false, null);
    else
      t1.xdata_0 = P.List_List$generate(t2, new U.plot_closure0(), false, null);
  } else if (style1 === "data")
    t1.xdata_0 = P.List_List$generate(y1.length, new U.plot_closure1(t1), false, null);
  _ydata = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
  _ydata.$indexSet(_ydata, "y1", y1);
  _ydata.$indexSet(_ydata, "y2", y2);
  _ydata.$indexSet(_ydata, "y3", y3);
  _ydata.$indexSet(_ydata, "y4", y4);
  _style = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
  _style.$indexSet(_style, "y1", style1);
  _style.$indexSet(_style, "y2", style1);
  _style.$indexSet(_style, "y3", style1);
  _style.$indexSet(_style, "y4", style1);
  _color = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
  _color.$indexSet(_color, "y1", color1);
  _color.$indexSet(_color, "y2", color2);
  _color.$indexSet(_color, "y3", color3);
  _color.$indexSet(_color, "y4", color4);
  return U.Plot2D$(context, _ydata, t1.xdata_0, _color, _style, 600, _pheight, linewidth);
},

_AxisConfig: {"": "Object;",
  axes$3: function(listMin, listMax, distance) {
    var numDivs, divSp, minsc, maxsc;
    numDivs = C.JSNumber_methods.toInt$0(Math.floor(distance / 50));
    divSp = this.idealTicks$2(this.idealRange$2(listMin, listMax), numDivs);
    if (typeof listMin !== "number")
      throw listMin.$div();
    minsc = Math.floor(listMin / divSp) * divSp;
    if (typeof listMax !== "number")
      throw listMax.$div();
    maxsc = Math.ceil(listMax / divSp) * divSp;
    if (minsc === maxsc) {
      minsc = 0.5 * minsc;
      maxsc = 1.5 * maxsc;
    }
    return new U._AxisConfigResults(distance * divSp / (maxsc - minsc), minsc, maxsc, divSp);
  },
  idealRange$2: function(listMin, listMax) {
    var range, t1, exponent, fraction, ideal;
    range = J.$sub$n(listMax, listMin);
    if (J.$eq(range, 0))
      range = J.$eq(listMin, 0) ? 1 : listMin;
    if (typeof range !== "number")
      H.throwExpression(new P.ArgumentError(range));
    t1 = Math.log(range);
    exponent = Math.floor(t1 / Math.log(10));
    ...
    if (fraction <= 1)
      ...
      ideal = fraction <= 5 ? 5 : 10;
    return ideal * Math.pow(10, exponent);
  },
  idealTicks$2: function(delta, maxNumTics) {
    var range, t1, exponent;
    range = delta / maxNumTics;
    t1 = Math.log(range);
    exponent = C.JSNumber_methods.toInt$0(Math.floor(t1 / Math.log(10)));
    range *= Math.pow(10, -exponent);
    if (range > 5)
      range = 10;
    else if (range > 2)
      range = 5;
      ...
      range = 2;
    return range * Math.pow(10, exponent);
  }
},

_AxisConfigResults: {"": "Object;div,min,max,step"},

plot_closure: {"": "Closure;",
  call$1: function(index) {
    return J.$add$ns(index, 1);
  },
  $is_args1: true
},

plot_closure0: {"": "Closure;",
  call$1: function(index) {
    return index;
  },
  $is_args1: true
...
plot_closure1: {"": "Closure;box_0",
  call$1: function(index) {
    var t1 = this.box_0.xdata_0;
    if (0 >= t1.length)
      throw H.ioore(t1, 0);
    return J.$add$ns(index, t1[0]);
  },
  $is_args1: true
},

Plot2D: {"": "Object;_yAxisCfg,_xAxisCfg,_border,_borderL,_borderT,_tickSize,_simplot$_index,context,_ydata,_color,_style,_xdata,_pwidth,_pheight,_linewidth,_xmin,_xmax,_xdiv,_xstep,_ymin,_ymax,_ydiv,_ystep,_dataLength,_yWithData",
  _drawData$2: function(dataColor, yvals) {
    var t1, t2, t3, t4, t5, j, t6, t7, t8, i, t9;
    t1 = this.context;
    t1.strokeStyle = dataColor;
    t2 = this._borderL;
    t3 = this._xdata;
    t4 = this._pheight - this._borderT;
    t5 = J.getInterceptor$asx(yvals);
    j = 0;
    while (true) {
      t6 = this._dataLength;
      if (typeof t6 !== "number")
      ...
      i = t2 + t6 / t7 * t8;
      t1.beginPath();
      t8 = C.JSNumber_methods.toInt$0(i);
      t7 = this._ymin;
      t6 = this._ystep;
      if (typeof t6 !== "number")
        throw H.iae(t6);
      ...
      if (typeof t9 !== "number")
        throw H.iae(t9);
      t1.moveTo(t8, t4 - (0 - t7) / t6 * t9);
      t9 = C.JSNumber_methods.toInt$0(i);
      t6 = J.$sub$n(t5.$index(yvals, j), this._ymin);
      t7 = this._ystep;
      if (typeof t6 !== "number")
        throw t6.$div();
      if (typeof t7 !== "number")
      ...
      if (typeof t8 !== "number")
        throw H.iae(t8);
      t1.lineTo(t9, t4 - t6 / t7 * t8);
      t1.stroke();
      t1.beginPath();
      t8 = C.JSNumber_methods.toInt$0(i);
      t7 = J.$sub$n(t5.$index(yvals, j), this._ymin);
      t6 = this._ystep;
      if (typeof t7 !== "number")
        throw t7.$div();
      if (typeof t6 !== "number")
      ...
      if (typeof t9 !== "number")
        throw H.iae(t9);
      t1.arc(t8, t4 - t7 / t6 * t9, 4, 0, 6.283185307179586, false);
      t1.closePath();
      t1.stroke();
      ++j;
    }
  },
  _drawPoints$2: function(dataColor, yvals) {
    var t1, t2, t3, t4, t5, j, t6, t7, t8, t9;
    t1 = this.context;
    t1.strokeStyle = dataColor;
    t2 = this._borderL;
    t3 = this._xdata;
    ...
    while (true) {
      ...
      if (typeof t8 !== "number")
        throw H.iae(t8);
      t1.beginPath();
      t8 = C.JSNumber_methods.toInt$0(t2 + t6 / t7 * t8);
      t7 = J.$sub$n(t5.$index(yvals, j), this._ymin);
      t6 = this._ystep;
      if (typeof t7 !== "number")
        throw t7.$div();
  ...
  _drawCurve$3: function(dataColor, yvals, style) {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, j, a, j0, c, t12, t13, t14, t15, t16, t17;
    t1 = this.context;
    t1.strokeStyle = dataColor;
    t1.beginPath();
    t1.lineJoin = "round";
    t2 = this._borderL;
    t3 = this._xdata;
    t4 = this._simplot$_index;
    if (t4 < 0 || t4 >= t3.length)
      throw H.ioore(t3, t4);
    t5 = J.$sub$n(t3[t4], this._xmin);
    t6 = this._xstep;
    if (typeof t5 !== "number")
      throw t5.$div();
    if (typeof t6 !== "number")
    ...
    if (typeof t7 !== "number")
      throw H.iae(t7);
    t8 = this._pheight - this._borderT;
    t9 = J.getInterceptor$asx(yvals);
    t4 = J.$sub$n(t9.$index(yvals, t4), this._ymin);
    t10 = this._ystep;
    if (typeof t4 !== "number")
      throw t4.$div();
    ...
    if (typeof t11 !== "number")
      throw H.iae(t11);
    t1.moveTo(t2 + t5 / t6 * t7, t8 - t4 / t10 * t11);
    j = 1;
    while (true) {
      t4 = this._dataLength;
      if (typeof t4 !== "number")
      ...
      if (typeof t4 !== "number")
        throw H.iae(t4);
      t7 = J.$sub$n(t9.$index(yvals, j), this._ymin);
      t10 = this._ystep;
      if (typeof t7 !== "number")
        throw t7.$div();
      if (typeof t10 !== "number")
      ...
      if (typeof t11 !== "number")
        throw H.iae(t11);
      c = t8 - t7 / t10 * t11;
      t11 = J.$sub$n(t9.$index(yvals, j0), this._ymin);
      t10 = this._ystep;
      if (typeof t11 !== "number")
        throw t11.$div();
      if (typeof t10 !== "number")
      ...
      if (typeof t7 !== "number")
        throw H.iae(t7);
      t1.quadraticCurveTo(a, c, (a + (t2 + t6 / t5 * t4)) / 2, (c + (t8 - t11 / t10 * t7)) / 2);
      j = j0;
    }
    if (t4 < 0 || t4 >= t6)
      throw H.ioore(t3, t4);
    ...
    if (typeof t11 !== "number")
      throw H.iae(t11);
    t12 = this._dataLength;
    if (typeof t12 !== "number")
      throw t12.$sub();
    t12 = J.$sub$n(t9.$index(yvals, t12 - 2), this._ymin);
    t13 = this._ystep;
    if (typeof t12 !== "number")
      throw t12.$div();
    ...
    if (typeof t14 !== "number")
      throw H.iae(t14);
    t15 = this._dataLength;
    if (typeof t15 !== "number")
      throw t15.$sub();
    t15 = J.$sub$n(t9.$index(yvals, t15 - 1), this._ymin);
    t16 = this._ystep;
    if (typeof t15 !== "number")
      throw t15.$div();
    ...
    if (typeof t17 !== "number")
      throw H.iae(t17);
    t1.quadraticCurveTo(t2 + t4 / t5 * t6, t8 - t12 / t13 * t14, t2 + t7 / t10 * t11, t8 - t15 / t16 * t17);
    t1.stroke();
    if (J.$eq(style, "curvepts")) {
      t1.fillStyle = dataColor;
      j = 0;
      while (true) {
        t4 = this._dataLength;
        if (typeof t4 !== "number")
        ...
        if (typeof t6 !== "number")
          throw H.iae(t6);
        t1.beginPath();
        t6 = C.JSNumber_methods.toInt$0(t2 + t4 / t5 * t6);
        t5 = J.$sub$n(t9.$index(yvals, j), this._ymin);
        t4 = this._ystep;
        if (typeof t5 !== "number")
          throw t5.$div();
        if (typeof t4 !== "number")
        ...
        if (typeof t7 !== "number")
          throw H.iae(t7);
        t1.arc(t6, t8 - t5 / t4 * t7, 4, 0, 6.283185307179586, false);
        t1.closePath();
        t1.fill();
        ++j;
      }
  ...
  _drawLine$3: function(dataColor, yvals, style) {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, j;
    t1 = this.context;
    t1.strokeStyle = dataColor;
    t1.beginPath();
    t1.lineJoin = "round";
    ...
    while (true) {
      ...
      if (typeof t7 !== "number")
        throw H.iae(t7);
      t1.lineTo(t6, t8 - t5 / t4 * t7);
      t1.stroke();
      ++j;
    }
    if (J.$eq(style, "linepts")) {
      t1.fillStyle = dataColor;
      j = 0;
      while (true) {
        t4 = this._dataLength;
  ...
  grid$0: function() {
    var _offset, t1, t2, i, t3, t4, t5, j;
    _offset = this._xdiv;
    t1 = this.context;
    t1.fillStyle = "black";
    t1.lineWidth = 1;
    ...
    if (typeof _offset !== "number")
      throw H.iae(_offset);
    i = t2 + _offset;
    t2 = this._pwidth - (this._border - t2);
    t3 = this._borderT;
    t4 = this._pheight - t3;
    for (; i < t2; i += _offset) {
      t5 = this._ydiv;
      ...
      while (j > t3) {
        t1.beginPath();
        t1.arc(C.JSNumber_methods.toInt$0(i) + 0.5, C.JSNumber_methods.toInt$0(j) + 0.5, 1, 0, 6.283185307179586, false);
        t1.closePath();
        t1.fill();
        t5 = this._ydiv;
        if (typeof t5 !== "number")
  ...
  xlabel$3$color$font: function(xlabelName, color, font) {
    var t1 = this.context;
    t1.fillStyle = color;
    t1.font = font;
    t1.textAlign = "center";
    J.fillText$3$x(t1, xlabelName, (this._pwidth + 2 * this._borderL - this._border) / 2, this._pheight - this._borderT / 10);
  },
  xlabel$2$color: function(xlabelName, color) {
    return this.xlabel$3$color$font(xlabelName, color, "11pt Verdana");
  },
  ylabel$3$color$font: function(ylabelName, color, font) {
    var t1, _deltax, _deltay;
    t1 = this.context;
    t1.measureText(ylabelName);
    _deltax = this._borderL / 4;
    _deltay = this._pheight / 2;
    t1.fillStyle = color;
    t1.font = font;
    t1.textAlign = "center";
    t1.save();
    t1.translate(_deltax, _deltay);
    t1.rotate(-1.5707963267948966);
    t1.translate(-_deltax, -_deltay);
    C.CanvasRenderingContext2D_methods.fillText$3(t1, ylabelName, 0, _deltay);
    t1.restore();
  },
  ylabel$1: function(ylabelName) {
    return this.ylabel$3$color$font(ylabelName, "DarkSlateGray", "11pt Verdana");
  },
  Plot2D$8: function(context, _ydata, _xdata, _color, _style, _pwidth, _pheight, _linewidth) {
    var t1, t2, t3, _first, _miny, _maxy, value, _tempMin, _tempMax, t4, t5, t6, t7, _offset, _increment, t8, t9, t10, i, i0, _tickPt, j, numDigits, waveform;
    for (t1 = this._ydata, t2 = t1.get$values(t1), t3 = t2._iterable, t3 = t3.get$iterator(t3), t3 = new H.MappedIterator(null, t3, t2._f), H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "MappedIterable", 0), H.getRuntimeTypeArgument(t2, "MappedIterable", 1)]), _first = true, _miny = null, _maxy = null; t3.moveNext$0();) {
      value = t3._dev$_current;
      if (value != null) {
        t2 = J.getInterceptor$asx(value);
        if (t2.get$isEmpty(value) === true)
          throw H.wrapException(new P.ArgumentError("Empty data lists are not supported."));
        else if (_first) {
          _miny = t2.fold$2(value, t2.get$first(value), P.min$closure);
          _maxy = t2.fold$2(value, t2.get$first(value), P.max$closure);
          _first = false;
        } else {
          _tempMin = t2.fold$2(value, t2.get$first(value), P.min$closure);
          if (J.$lt$n(_tempMin, _miny))
            _miny = _tempMin;
          _tempMax = t2.fold$2(value, t2.get$first(value), P.max$closure);
          if (J.$gt$n(_tempMax, _maxy))
            _maxy = _tempMax;
        }
      }
    }
    ...
    t4 = this._border;
    t5 = t3 - t4;
    this._xAxisCfg = new U._AxisConfig().axes$3(H.IterableMixinWorkaround_fold(t2, J.getInterceptor$ax(t2).get$first(t2), P.min$closure), H.IterableMixinWorkaround_fold(t2, C.JSArray_methods.get$first(t2), P.max$closure), t5);
    t6 = this._pheight;
    t7 = t6 - t4;
    this._yAxisCfg = new U._AxisConfig().axes$3(_miny, _maxy, t7);
    this._xmin = this._xAxisCfg.min;
    this._xmax = this._xAxisCfg.max;
    this._xdiv = this._xAxisCfg.div;
    this._xstep = this._xAxisCfg.step;
    this._ymin = this._yAxisCfg.min;
    this._ymax = this._yAxisCfg.max;
    this._ydiv = this._yAxisCfg.div;
    this._ystep = this._yAxisCfg.step;
    _offset = this._xdiv;
    _increment = this._xstep;
    t8 = this.context;
    t8.strokeStyle = "rgb(85, 98, 112)";
    t8.lineCap = "round";
    t8.lineWidth = 2;
    t9 = this._borderL;
    t10 = this._borderT;
    t8.strokeRect(t9, t10, t5, t7);
    t8.lineWidth = 1;
    if (typeof _offset !== "number")
      throw H.iae(_offset);
    i = t9 + _offset;
    ...
    for (; i < t3; i += _offset) {
      t8.beginPath();
      t8.moveTo(C.JSNumber_methods.toInt$0(i) + 0.5, i0);
      t8.lineTo(C.JSNumber_methods.toInt$0(i) + 0.5, t4);
      t8.stroke();
      t8.moveTo(C.JSNumber_methods.toInt$0(i) + 0.5, t5);
      t8.lineTo(C.JSNumber_methods.toInt$0(i) + 0.5, t10);
      t8.stroke();
    }
    t8.textAlign = "center";
    t8.font = "10pt Consolas";
    _tickPt = this._xmin;
    if (_increment === J.toInt$0$n(_increment)) {
      j = this._xmin;
      t4 = i0 + t10 / 3;
      while (true) {
        t5 = this._xmax;
        ...
        if (!(j <= t5))
          break;
        t5 = C.JSInt_methods.toString$0(C.JSNumber_methods.toInt$0(j));
        t7 = this._xmin;
        if (typeof t7 !== "number")
          throw H.iae(t7);
        t8.fillText(t5, t9 + (j - t7) / _increment * _offset, t4);
        if (typeof _tickPt !== "number")
          throw _tickPt.$add();
        _tickPt += _increment;
        j += _increment;
      }
      ...
      while (true) {
        ...
        if (!(j <= t5))
          break;
        t5 = C.JSNumber_methods.toStringAsFixed$1(j, numDigits);
        t7 = this._xmin;
        if (typeof t7 !== "number")
          throw H.iae(t7);
        t8.fillText(t5, t9 + (j - t7) / _increment * _offset, t4);
    ...
    t5 = t3 - t6;
    while (i > t10) {
      t8.moveTo(t9, C.JSNumber_methods.toInt$0(i) + 0.5);
      t8.lineTo(t4, C.JSNumber_methods.toInt$0(i) + 0.5);
      t8.stroke();
      t8.moveTo(t3, C.JSNumber_methods.toInt$0(i) + 0.5);
      t8.lineTo(t5, C.JSNumber_methods.toInt$0(i) + 0.5);
      t8.stroke();
      t7 = this._ydiv;
      if (typeof t7 !== "number")
        throw H.iae(t7);
    ...
    if (t3 === J.toInt$0$n(t3)) {
      ...
      while (true) {
        ...
        if (!(i > t10 - t4 / 2))
          break;
        t4 = C.JSInt_methods.toString$0(C.JSNumber_methods.toInt$0(_tickPt));
        t5 = C.JSNumber_methods.toInt$0(i);
        t8.fillText(t4, t3, t5);
        t4 = this._ystep;
        if (typeof t4 !== "number")
          throw H.iae(t4);
        _tickPt += t4;
      ...
      while (true) {
        ...
        if (!(i > t10 - t4 / 2))
          break;
        t4 = C.JSNumber_methods.toStringAsFixed$1(_tickPt, numDigits);
        t5 = C.JSNumber_methods.toInt$0(i);
        t8.fillText(t4, t3, t5);
        t4 = this._ystep;
        if (typeof t4 !== "number")
    ...
    for (t3 = new P.LinkedHashMapKeyIterable(t1), H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_LinkedHashMap", 0)]), t3 = t3._map, t3 = new P.LinkedHashMapKeyIterator(t3, t3._modifications, null, null), t3._cell = t3._map._first, t4 = this._style, t5 = this._linewidth, t6 = this._color; t3.moveNext$0();) {
      waveform = t3._collection$_current;
      if (t1.$index(t1, waveform) != null) {
        this._yWithData = this._yWithData + 1;
        t7 = J.get$length$asx(t1.$index(t1, waveform));
        t9 = t2.length;
        if (typeof t7 !== "number")
          throw t7.$gt();
        if (t7 > t9)
          ...
          this._dataLength = J.get$length$asx(t1.$index(t1, waveform));
        if (J.$eq(t4.$index(t4, waveform), "data")) {
          t8.lineWidth = t5;
          this._drawData$2(t6.$index(t6, waveform), t1.$index(t1, waveform));
        } else if (J.$eq(t4.$index(t4, waveform), "points")) {
          t8.lineWidth = t5;
          this._drawPoints$2(t6.$index(t6, waveform), t1.$index(t1, waveform));
        } else if (J.$eq(t4.$index(t4, waveform), "curve") || J.$eq(t4.$index(t4, waveform), "curvepts")) {
          t8.lineWidth = t5;
          this._drawCurve$3(t6.$index(t6, waveform), t1.$index(t1, waveform), t4.$index(t4, waveform));
        } else if (J.$eq(t4.$index(t4, waveform), "line") || J.$eq(t4.$index(t4, waveform), "linepts")) {
          t8.lineWidth = t5;
          this._drawLine$3(t6.$index(t6, waveform), t1.$index(t1, waveform), t4.$index(t4, waveform));
        }
      }
    }
  },
  static: {
Plot2D$: function(context, _ydata, _xdata, _color, _style, _pwidth, _pheight, _linewidth) {
  var t1 = new U.Plot2D(null, null, 100, 80, 50, 5, 0, context, _ydata, _color, _style, _xdata, _pwidth, _pheight, _linewidth, null, null, null, null, null, null, null, null, null, 0);
  t1.Plot2D$8(context, _ydata, _xdata, _color, _style, _pwidth, _pheight, _linewidth);
  return t1;
}}
...
init.globalFunctions.min$closure = P.min$closure = new H.Closure$2(P.min, "min$closure");
...
Isolate.$lazy($, "dataQueue", "dataQueue", "get$dataQueue", function() {
  return P.ListQueue$(null, null);
});
Isolate.$lazy($, "output", "output", "get$output", function() {
  return document.querySelector("#output");
});
Isolate.$lazy($, "plotArea", "plotArea", "get$plotArea", function() {
  return document.querySelector("#simPlotHere");
});
Isolate.$lazy($, "lineUp", "lineUp", "get$lineUp", function() {
  var t1 = new P._GeneratorIterable(30, new G.closure());
  H.setRuntimeTypeInfo(t1, [null]);
...
function dart_precompiled($collectedClasses) {
  ...
  function ListIterator(_iterable, _length, _dev$_index, _dev$_current) {
    this._iterable = _iterable;
    this._length = _length;
    this._dev$_index = _dev$_index;
  ...
  function _GeneratorIterator(_count, _generator, _index, _current) {
    this._count = _count;
    this._generator = _generator;
    this._index = _index;
  ...
  _AxisConfig.builtin$cls = "_AxisConfig";
  if (!"name" in _AxisConfig)
    _AxisConfig.name = "_AxisConfig";
  $desc = $collectedClasses._AxisConfig;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _AxisConfig.prototype = $desc;
  function _AxisConfigResults(div, min, max, step) {
    this.div = div;
    this.min = min;
    this.max = max;
    this.step = step;
  }
  _AxisConfigResults.builtin$cls = "_AxisConfigResults";
  if (!"name" in _AxisConfigResults)
    _AxisConfigResults.name = "_AxisConfigResults";
  $desc = $collectedClasses._AxisConfigResults;
  if ($desc instanceof Array)
    $desc = $desc[1];
  _AxisConfigResults.prototype = $desc;
  function plot_closure() {
  }
  plot_closure.builtin$cls = "plot_closure";
  if (!"name" in plot_closure)
    plot_closure.name = "plot_closure";
  $desc = $collectedClasses.plot_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  plot_closure.prototype = $desc;
  function plot_closure0() {
  }
  plot_closure0.builtin$cls = "plot_closure0";
  if (!"name" in plot_closure0)
    plot_closure0.name = "plot_closure0";
  $desc = $collectedClasses.plot_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  plot_closure0.prototype = $desc;
  function plot_closure1(box_0) {
    this.box_0 = box_0;
  }
  plot_closure1.builtin$cls = "plot_closure1";
  if (!"name" in plot_closure1)
    plot_closure1.name = "plot_closure1";
  $desc = $collectedClasses.plot_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  plot_closure1.prototype = $desc;
  function Plot2D(_yAxisCfg, _xAxisCfg, _border, _borderL, _borderT, _tickSize, _simplot$_index, context, _ydata, _color, _style, _xdata, _pwidth, _pheight, _linewidth, _xmin, _xmax, _xdiv, _xstep, _ymin, _ymax, _ydiv, _ystep, _dataLength, _yWithData) {
    this._yAxisCfg = _yAxisCfg;
    this._xAxisCfg = _xAxisCfg;
    this._border = _border;
    this._borderL = _borderL;
    this._borderT = _borderT;
    this._tickSize = _tickSize;
    this._simplot$_index = _simplot$_index;
    ...
    this._yWithData = _yWithData;
  }
  Plot2D.builtin$cls = "Plot2D";
  if (!"name" in Plot2D)
    Plot2D.name = "Plot2D";
  $desc = $collectedClasses.Plot2D;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Plot2D.prototype = $desc;
